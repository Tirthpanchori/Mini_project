  ...
  if (!result) return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6">
      <div className="text-center">
        ...
        <button onClick={() => navigate(-1)} className="px-5 py-2.5 rounded-xl bg-slate-800 text-white hover:bg-slate-700 transition-colors">
          Go Back
        </button>
      </div>
    </div>
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-violet-500/30 p-6 md:p-8 lg:p-12">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        >
          <ArrowLeft size={16} /> Back to Student Attempts
        </button>
                      ...
                      <div className="grid md:grid-cols-2 gap-4 text-sm">
                         <div className={`p-3 rounded-lg border ${
                           ...
                           : "bg-rose-500/5 border-rose-500/10"
                            ...
                            <p className="text-slate-500 text-xs mb-1">Student's Answer</p>
                            <p className={q.is_correct ? "text-emerald-300 font-medium" : "text-rose-300 font-medium"}>
                     ...
                     {aiAnalysis.total_incorrect === 0 && (
                        <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 flex items-center gap-3">
                           ...
                           <div>
                              ...
                              <p className="text-sm text-emerald-300/80">Great job! Keep challenging the student with advanced topics.</p>
                           </div>
                        </div>
                     )}
                  </div>
