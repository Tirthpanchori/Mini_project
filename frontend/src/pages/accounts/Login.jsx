...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col md:flex-row font-sans selection:bg-violet-500/30">
      ...
      <div className="w-full md:w-1/2 lg:w-[45%] bg-slate-900 border-r border-slate-800 relative hidden md:flex flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          >
            <div className="bg-gradient-to-br from-violet-600 to-indigo-600 p-2.5 rounded-xl shadow-lg shadow-violet-500/20 group-hover:scale-105 transition-transform duration-300">
        ...
        <div className="relative z-10 space-y-8">
           ...
           <p className="text-slate-400 text-lg leading-relaxed max-w-md">
             Join thousands of learners transforming their potential into mastery through our intelligent styling ecosystem.
           </p>
      ...
      <div className="w-full md:w-1/2 lg:w-[55%] flex items-center justify-center p-6 relative">
         ...
         >
            ...
            <p className="text-center text-slate-500 text-sm mt-8">
              By continuing, you agree to our <a href="#" className="text-violet-400 hover:text-violet-300">Terms</a> and <a href="#" className="text-violet-400 hover:text-violet-300">Privacy Policy</a>.
            </p>
         </motion.div>
      </div>
